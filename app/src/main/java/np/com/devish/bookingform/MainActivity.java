package np.com.devish.bookingform;
...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    TextView tvChkinDate, tvChkoutDate, tvResult, tvRoomPrice;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Binding
        tvChkinDate = findViewById(R.id.tvChkinDate);
        tvChkoutDate = findViewById(R.id.tvChkoutDate);
        ...
        // For Checkin Date
        tvChkinDate.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // For Checkout Date
        tvChkoutDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadCheckoutDate();
            }
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(etChild.getText())) {
                    etChild.setError("Please enter number of childrens.");
                    return;
                }
                ...
                if (spnrRoomType.getSelectedItem() == "Delux - Rs. 2000") {
                    tvRoomPrice.setText("2000");
                }
                if (spnrRoomType.getSelectedItem() == "Presenditial - Rs. 5000") {
                    tvRoomPrice.setText("5000");
                }
                if (spnrRoomType.getSelectedItem() == "Premium - Rs. 4000") {
